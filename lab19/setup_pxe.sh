...
LABEL linux-auto
  ...
  kernel images/CentOS-8.3/vmlinuz
  append initrd=images/CentOS-8.3/initrd.img ip=enp0s3:dhcp inst.repo=http://10.0.0.20/centos8-autoinstall inst.ks=http://10.0.0.20/ks.cfg
LABEL vesa
...
#  curl -O http://ftp.mgts.by/pub/CentOS/8.3.2011/isos/x86_64/CentOS-8.2.2004-x86_64-minimal.iso
